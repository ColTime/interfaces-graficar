...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-11-2017 a las 22:07:55
...
UPDATE proyecto p SET p.estado_idestado=3 WHERE p.numero_orden = orden;
ELSE
 ...
 UPDATE proyecto p SET p.estado_idestado=4 WHERE p.numero_orden = orden;
 ELSE
 ...
 UPDATE proyecto p SET p.estado_idestado=2 WHERE p.numero_orden = orden;
  END IF;
 END IF;
END IF;
...
(743, '00:00', '102:28', '5', '2017-11-01', NULL, 129, 1, 2, '11:46:57', '13:14:25'),
...
(748, '00:00', '00:00', '0', NULL, NULL, 129, 6, 1, NULL, NULL),
...
(129, 1, '10', 'TH', 28542, 1, 2, 0, NULL, 8, 0, 2, 0);
...
--
ALTER TABLE `detalle_formato_estandar`
  MODIFY `idDetalle_formato_estandar` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=753;

--
-- AUTO_INCREMENT de la tabla `detalle_proyecto`
--
ALTER TABLE `detalle_proyecto`
  MODIFY `idDetalle_proyecto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=130;
