...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-11-2017 a las 18:08:21
...
ELSE
#Busca todos los detalle del proyecto independientemente el área de produccioó.SELECT d.idDetalle_proyecto,t.nombre,d.estado_idestado  FROM detalle_proyecto d JOIN tipo_negocio t on d.tipo_negocio_idtipo_negocio=t.idtipo_negocio WHERE d.proyecto_numero_orden=orden AND d.PNC=pnc;
...
--
ALTER TABLE `detalle_ensamble`
  MODIFY `idDetalle_ensamble` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
...
--
ALTER TABLE `detalle_proyecto`
  MODIFY `idDetalle_proyecto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=243;
--
