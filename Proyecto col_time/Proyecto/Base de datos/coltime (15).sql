...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-11-2017 a las 22:59:07
...
(745, '00:00', '00:00', '0', NULL, NULL, 129, 3, 1, NULL, NULL),
...
(753, '00:00', '01:20', '0', '2017-11-02', NULL, 130, 1, 2, '08:08:44', '08:10:53'),
...
(129, 1, '10', 'TH', 28542, 1, 2, 0, NULL, 7, 0, 3, 0),
...
--
ALTER TABLE `detalle_formato_estandar`
  MODIFY `idDetalle_formato_estandar` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=771;

--
-- AUTO_INCREMENT de la tabla `detalle_proyecto`
--
ALTER TABLE `detalle_proyecto`
  MODIFY `idDetalle_proyecto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=132;
...
--
ALTER TABLE `proyecto`
  MODIFY `numero_orden` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28543;
