...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-10-2017 a las 23:40:39
...
ELSE
 IF pausar!=0 and ejecucion=0 and terminar=0 THEN
  ...
  UPDATE detalle_proyecto d SET d.estado_idestado=2 WHERE d.idDetalle_proyecto=detalle;
 ELSE 
  IF terminar!=0 AND ejecutar=0 AND pausar THEN
...
#Actualización
UPDATE detalle_proyecto SET pro_porIniciar=cantidadp WHERE idDetalle_proyecto=(SELECT MAX(idDetalle_proyecto) FROM detalle_proyecto);
...
#Actualización
UPDATE detalle_proyecto SET pro_porIniciar=cantidadp WHERE d.idDetalle_proyecto=detalle;
...
#Actualización
UPDATE detalle_proyecto SET pro_porIniciar=tipo WHERE idDetalle_proyecto=(SELECT MAX(idDetalle_proyecto) FROM detalle_proyecto);
...
--
ALTER TABLE `detalle_ensamble`
  MODIFY `idDetalle_ensamble` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `detalle_formato_estandar`
--
ALTER TABLE `detalle_formato_estandar`
  MODIFY `idDetalle_formato_estandar` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=603;

--
-- AUTO_INCREMENT de la tabla `detalle_proyecto`
--
ALTER TABLE `detalle_proyecto`
  MODIFY `idDetalle_proyecto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=96;
...
--
ALTER TABLE `proyecto`
  MODIFY `numero_orden` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28534;
