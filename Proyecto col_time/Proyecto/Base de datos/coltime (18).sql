...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-11-2017 a las 21:23:14
...
UPDATE detalle_proyecto SET pro_Terminado=cantidadp WHERE idDetalle_proyecto=detalle;
#Se cambia del detalle del proyectoCALL PA_CambiarEstadoDeProductos(negocio,detalle);
  RETURN 1;
ELSE
 IF negocio=2 THEN
...
(743, '00:00', '00:00', '0', NULL, NULL, 129, 1, 1, NULL, NULL),
(744, '00:00', '00:00', '0', NULL, NULL, 129, 2, 1, NULL, NULL),
...
(28543, '98113053240', 'juan david marulanda', 'prueba numero veite', 'RQT', 1, 1, 0, 1, 0, 1, 1, 1, 1, 0, '2017-11-03 13:32:49', '2017-11-04', NULL, 1, 1, 4, 0, 0);
