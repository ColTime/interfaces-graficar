...
public class screen extends javax.swing.JFrame implements Runnable {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 0, -1, 190));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Spinner.gif"))); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 199, -1, 70));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(83, 83, 83));
        jLabel3.setText("Cargando...");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(106, 199, 426, 70));
